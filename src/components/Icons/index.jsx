...
export const HomeIcon = ({ className, width = '3.2rem', height = '3.2rem', fill = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const HomeActiveIcon = ({ className, width = '3.2rem', height = '3.2rem', fill = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const UserGroupIcon = ({ className, width = '3.2rem', height = '3.2rem', fill = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const UserGroupActiveIcon = ({ className, width = '3.2rem', height = '3.2rem', fill = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LiveIcon = ({ className, width = '3.2rem', height = '3.2rem', fill = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const LiveActiveIcon = ({ className, width = '3.2rem', height = '3.2rem', fill = 'currentColor' }) => {
    return (
        <svg
            className={className}
            width={width}
